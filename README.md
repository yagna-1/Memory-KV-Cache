...
3. Run:
   ...
   - `cargo run -- run --profile llama_cpp_safe --model /path/to/model.gguf --monitor --monitor-warning 1gb --monitor-critical 2gb --abort-on-critical --warning-context-length 1024 --warning-max-tokens 256 --warning-threads 4 --warning-gpu-layers 8 --pressure-events`
